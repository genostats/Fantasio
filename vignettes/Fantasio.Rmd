...
`makeAllSubmapsByDistance` or `makeAllSubsmapsbyHotspots` is used to
create the submaps.
...
commands :
    ...
    F1 <- makeAllSubmapsByHotspots(x.be, 5, s1)
    F1 <- festim(F1)
...
<!-- -->
    ...
    ## 1 HGDP00607 HGDP00607      1   5 / 5     100 0.01904648 0.02982844
    ## 2 HGDP00608 HGDP00608      1   5 / 5     100 0.03768878 0.04105253
    ## 3 HGDP00609 HGDP00609      1   5 / 5     100 0.03927225 0.04879470
    ## 4 HGDP00610 HGDP00610      1   5 / 5     100 0.04962745 0.05549931
    ## 5 HGDP00611 HGDP00611      1   0 / 5      NA         NA         NA
    ## 6 HGDP00612 HGDP00612      1   5 / 5     100 0.05654334 0.07166133
    ##       F_MEAN   F_MEDIAN   A_MEDIAN  pLRT_MEDIAN INBRED pLRT_inf_0.05
    ## 1 0.02398260 0.02223782 0.12777625 6.389929e-28   TRUE             5
    ## 2 0.03938708 0.04008926 0.08056515 3.394329e-58   TRUE             5
    ## 3 0.04355957 0.04497204 0.11638164 2.523944e-51   TRUE             5
    ## 4 0.05171237 0.05123748 0.16288443 1.124609e-62   TRUE             5
    ## 5         NA         NA         NA           NA     NA            NA
    ## 6 0.06396400 0.06282001 0.36810700 3.393475e-40   TRUE             5
...
is put to TRUE. And we recommend to adjust "n.consecutive.marker".
    ...
    F2 <- makeAllSubmapsByHotspots(x.be, 5, s1)
    F2 <- festim(F2)
...
commands :
    ...
    F3 <- makeAllSubmapsByDistance(x.be, 5, s3)
    F3 <- festim(F3)
